...
cats.length.times{|i| CharacterRole.create(performer:Performer.all[i+10], production: Production.find_by(title:'Cats'), character_name:carmen[i-1])}
#Hamilton
...
hamilton.length.times{|i| CharacterRole.create(performer:Performer.all[i+10], production: Production.find_by(title:'Hamilton'), character_name:carmen[i-1])}
